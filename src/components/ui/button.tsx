...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-[14.5px] font-bold normal-case transition-transform disabled:pointer-events-none focus-visible:outline-none',
  {
    variants: {
      variant: {
